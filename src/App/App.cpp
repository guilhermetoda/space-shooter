...
bool App::Init(uint32_t width, uint32_t height, uint32_t mag)
{
    ...
    std::unique_ptr<ShooterGame> shooterGame = std::make_unique<ShooterGame>();
    std::unique_ptr<GameScene> shooterScene = std::make_unique<GameScene>(std::move(shooterGame));
    PushScene(std::move(shooterScene));
